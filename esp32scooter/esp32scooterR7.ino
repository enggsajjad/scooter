...
void loop()
{
  switch(rxState)
  {
    ...
    case set_cipstart:
      #ifdef THINGSPEAK
        r = sendATCommand("AT+CIPSTART=\"TCP\",\"api.thingspeak.com\",80", "CONNECT OK", "IP PROCESSING", 20000);//for thinkspeak
      #else
    ...
    case set_cipsend_complete:
      #ifdef THINGSPEAK
        r = sendATCommand((char*)message.c_str(), "ERROR", "ERROR", 500);
