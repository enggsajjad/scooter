...
/// Setting the servers and debugging control using the A9G
  ...
  #define sbaud  9600
  /// GPRS RX Pin
  //#define gprsRX 14 //Module AiThinker
  #define gprsRX 27 //PCB2,3,4 
  /// GPRS TX Pin
  //#define gprsTX 12//Module AiThinker
  #define gprsTX 14 //PCB2,3,4
  /// GPS RX Pin
  //#define gpsRX 13//Module AiThinker
  #define gpsRX 13 //PCB2,3,4
  /// GPS TX Pin
  #define gpsTX -1
  /// GPS PWR Pin
  //#define gprsPWR  33//Module AiThinker
  #define gprsPWR  25 //PCB2,3,4
  /// GPS RST Pin
